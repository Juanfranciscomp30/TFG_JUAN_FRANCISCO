  // Animación para eliminar producto (desvanece la card)
        ...
        $.ajax({
            ...
            success: function(response){
                if(response.success){
                    ...
                    $('#subtotal-' + id).html('<i class="fa-solid fa-money-bill"></i> Subtotal: €' + response.subtotal.toFixed(2));
                    // Actualiza el total sumando todos los subtotales visibles
                    let total = 0;
